...
if check == 'ML - Modeling':
    ...
    model = load(open(r'https://github.com/Rohankale0604/NLP-Project/blob/main/model.pkl', 'rb'))
    vectorizer = load(open(r'https://github.com/Rohankale0604/NLP-Project/blob/main/vectorizer.pkl', 'rb'))
